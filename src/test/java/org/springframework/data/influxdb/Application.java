...
public class Application implements CommandLineRunner
{
  ...
  public void run(final String... args) throws Exception
  {
	...
	InfluxDBConnectionFactory connectionFactory = null;
	// Connect to database
	influxDBTemplate.setConnectionFactory(connectionFactory);
	influxDBTemplate.getConnection();
